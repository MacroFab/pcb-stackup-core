...
module.exports = function(
  ...
  var cuLayerId = findLayers(layers, wtg.TYPE_COPPER)
  var smLayerId = findLayers(layers, wtg.TYPE_SOLDERMASK)
  var ssLayerId = findLayers(layers, wtg.TYPE_SILKSCREEN)
  var spLayerId = findLayers(layers, wtg.TYPE_SOLDERPASTE)
